struct Company {
  ...
  { parent = nullptr; merge1 = m1; merge2 = m2; }
   ~Company()
   {
      //reassign parents of children to nullptr if company has children
      if (merge1 && merge2){
         merge1->parent = nullptr;
         merge2->parent = nullptr;
      }
      delete parent; //recursively delete parent
   }
};
...
class CompanyTracker {
 public:
  ...
  Company* findRoot(int student_number);
